...
export default function OtherSection1() {
    return (
        <div className='relative w-full flex items-center justify-center px-5  md:px-10 py-3 md:py-6 my-5 md:my-20 ' data-aos="fade-up" data-aos-anchor-placement="start-start">
            ...
            <div className='w-full py-8 overflow-hidden bg-[#154D71] rounded-lg shadow-md flex flex-col items-center justify-center text-center px-6'>
                <h1 className='text-white text-3xl md:text-4xl lg:text-5xl font-medium mb-3'>
                    Ready to Work with Us?
                </h1>
                <p className='text-gray-200/90 font-normal  md:text-lg lg:text-xl max-w-3xl'>
