      ...
      <div className=" relative min-h-screen ">
        ...
        <div className=" min-h-screen relative z-10 flex flex-row items-center  justify-between px-5 md:px-14 bg-[#012A43]/50 text-white">
          <div className="flex flex-col gap-5">
            <h1 className="text-lg text-[#a9abad]  sm:text-lg md:text-lg lg:text-lg xl:text-xl  w-full md:w-3/4 ">
            ...
            <h4 className="text-lg sm:text-sm md:text-sm lg:text-lg xl:text-xl  w-full md:w-3/4 text-[#a9abad]">
