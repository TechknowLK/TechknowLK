...
const features = [
  {
    ...
    description:
      "End-to-end data security and infrastructure reliability for your peace of mind.",
  },
  {
    icon: Zap,
    title: "Cutting-Edge Technology",
    description:
      "Latest innovations in AI, IoT, and automation to keep you ahead of competitors.",
  },
  {
    icon: Clock,
    title: "24/7 Support",
  ...
  },
  {
    ...
    description:
      "International quality protocols and standards we follow and implement.",
  },
];
...
const WhyChoose = () => {
  ...
  AOS.refresh(); // ensures dynamically rendered elements animate
}, []);
  return (
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start px-6 ">
          <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="  shadow-[10px_10px_25px_rgba(0,0,0,0.13)] rounded-lg p-6 "
          ...
          >
            ...
            <p className="text-white/70 mb-8 text-sm">
              Our commitment to excellence has earned us recognition as #1
              technology solutions provider in Sri Lanka
            </p>
            <div className="space-y-4 ">
              {achievements.map((achievement, index) => (
                <div
                  key={index}
                  className="border-b border-white/10 pb-3 flex flex-row items-center gap-2"
                >
