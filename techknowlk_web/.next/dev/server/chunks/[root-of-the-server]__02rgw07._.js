...
"[project]/techknowlk_web/src/app/api/projects/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.findUnique({
            where: {
                id: parseInt(id)
            }
        });
        if (!project) return __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Not found'
        }, {
            status: 404
        });
...
async function PUT(req, { params }) {
    ...
    try {
        ...
        const updatedProject = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.update({
            where: {
                id: parseInt(id)
            },
            data: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedProject, {
            status: 200
        });
    } catch (error) {
...
async function DELETE(req, { params }) {
    ...
    const { id } = await params;
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.delete({
            where: {
                id: parseInt(id)
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02rgw07._.js.map