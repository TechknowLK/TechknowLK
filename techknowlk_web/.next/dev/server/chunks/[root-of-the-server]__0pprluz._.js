...
"[project]/techknowlk_web/src/app/api/client-projects/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const projects = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].clientProject.findMany({
            orderBy: {
                id: 'desc'
            },
            include: {
...
async function POST(req) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].clientProject.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0pprluz._.js.map