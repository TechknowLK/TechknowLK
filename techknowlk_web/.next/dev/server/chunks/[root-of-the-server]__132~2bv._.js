...
async function GET() {
    try {
        const projects = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.findMany({
            orderBy: {
                id: 'desc'
            }
        });
...
async function POST(req) {
    ...
    try {
        ...
        const newProject = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.create({
            data: {
                title: data.title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__132~2bv._.js.map