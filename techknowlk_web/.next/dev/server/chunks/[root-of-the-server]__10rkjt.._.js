...
"[project]/techknowlk_web/src/app/api/shop/sub-categories/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function verifyAdmin() {
    const cookieStore = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])();
...
async function GET(req) {
    ...
    try {
        ...
        const subCategories = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopSubCategory.findMany({
            where,
            orderBy: {
                name: 'asc'
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(subCategories, {
            status: 200
        });
    } catch (error) {
...
async function POST(req) {
    ...
    if (!isAdmin) return __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Unauthorized'
    }, {
        status: 401
    });
    try {
        ...
        if (!name || !categoryId) return __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Name and Category ID are required'
        }, {
            status: 400
        });
        const newSubCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$src$2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopSubCategory.create({
            data: {
                name,
                categoryId: parseInt(categoryId)
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$techknowlk_web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newSubCategory, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10rkjt.._.js.map